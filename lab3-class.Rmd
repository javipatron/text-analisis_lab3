...
2.  Clean the data as appropriate. (Clean the data with stopwords)
...
- Optimization metrics (Understand the topics)
- Create 3 values of key
...
Use the words, use what you know about the articles, and do an interpretation of what they mean. 
